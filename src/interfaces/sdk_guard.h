...
public:
    ...
    virtual void CheckForPSNGameBootInvite(unsigned int);
    virtual void ServerResponded(void*, int);
    virtual void ServerFailedToRespond(void*, int);
    virtual void RefreshComplete(void*, int);
    virtual void ServerResponded2(void*);
    virtual void ServerFailedToRespond2();
    ...
    virtual void* RequestInternetServerList(AppId_t, void**, unsigned int, void*);
    virtual void* RequestLANServerList(AppId_t, void*);
    virtual void* RequestFriendsServerList(AppId_t, void**, unsigned int, void*);
    virtual void* RequestFavoritesServerList(AppId_t, void**, unsigned int, void*);
    virtual void* RequestHistoryServerList(AppId_t, void**, unsigned int, void*);
    virtual void* RequestSpectatorServerList(AppId_t, void**, unsigned int, void*);
    virtual void ReleaseRequest(void*);
    virtual void* GetServerDetails(void*, int);
    ...
    virtual int PingServer(unsigned int, unsigned short, void*);
    virtual int PlayerDetails(unsigned int, unsigned short, void*);
    virtual int ServerRules(unsigned int, unsigned short, void*);
    virtual void CancelServerQuery(int);
    virtual int AddGameSearchParams(const char*, const char*);
    virtual int SearchForGameWithLobby(SdkSteamID, int, int);
    virtual int SearchForGameSolo(int, int);
    virtual int AcceptGame();
    virtual int DeclineGame();
    virtual int RetrieveConnectionDetails(SdkSteamID, char*, int);
    virtual int EndGameSearch();
    virtual int SetGameHostParams(const char*, const char*);
    virtual int SetConnectionDetails(const char*, int);
    virtual int RequestPlayersForGame(int, int, int);
    virtual int HostConfirmGameStart(unsigned long long);
    virtual int CancelRequestPlayersForGame();
    virtual int SubmitPlayerResult(unsigned long long, SdkSteamID, int);
    virtual int EndGame(unsigned long long);
    virtual unsigned int GetNumActiveBeacons();
    virtual unsigned long long GetBeaconByIndex(unsigned int);
    virtual bool GetBeaconDetails(unsigned long long, SdkSteamID*, void*, char*, int);
    virtual unsigned long long JoinParty(unsigned long long);
    virtual bool GetNumAvailableBeaconLocations(void*, unsigned int);
    virtual bool GetAvailableBeaconLocations(void*, unsigned int, unsigned int);
    virtual unsigned long long CreateBeacon(unsigned int, void*, const char*, const char*);
    virtual void OnReservationCompleted(unsigned long long, SdkSteamID);
    virtual void CancelReservation(unsigned long long, SdkSteamID);
    virtual unsigned long long ChangeNumOpenSlots(unsigned long long, unsigned int);
    virtual bool DestroyBeacon(unsigned long long);
    virtual bool GetBeaconLocationData(void*, int, char*, int);
};
